...
# Load data
co2_df = pd.read_csv(r'C:\Users\jpaul\OneDrive\Documents\Climate_Study\cleaned_owid_co2_data.csv')
temp_df = pd.read_csv(r'C:\Users\jpaul\OneDrive\Documents\Climate_Study\GLB.Ts+dSST.csv')
...
# Filtered Data
filtered_co2 = global_df[(global_df['Year'] >= year_range[0]) & (global_df['Year'] <= year_range[1])]
